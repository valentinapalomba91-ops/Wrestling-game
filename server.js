...
function initializeGame() {
    ...
    // 💡 Modifiche Aggiunte: reset completo dello stato per una nuova partita pulita
    gameState.gameLog = []; // Azzeramento Cronologia
    gameState.currentTurnIndex = 0; // Reset del turno iniziale
    // ---------------------------------------------------------------------
